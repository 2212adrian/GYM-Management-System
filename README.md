...
- `QUICK_LOGIN_HASH_SECRET` (recommended, used to SHA-256 hash quick-login requester identity and IP metadata)
- `QUICK_LOGIN_EXPIRES_SECONDS` (optional, defaults to `120`)
- `QUICK_LOGIN_REGENERATE_COOLDOWN_SECONDS` (optional, defaults to `8`)
